...
md = '/Users/ecarruth/Desktop/Daya_test_20170928/'

########### Continuity model filename
model = 'EDC_fitted_tricubic_matmod'
...
xifile = 'XiTable_fitted_tricubic_DT_maskcoords.txt'
...
# Load data file
print 'Loading fitting data file %s'%(md+data_file)
self.LoadFittingData(md + data_file, log=0)
...
# homogenous weights
 ...
 #        'output_type':'Update nodal variable'}, log=0)
        ...
        self.FitData({'iterationLimit':'10','calcErrorStr':'error = (data-x)*weight\n',\
            ...
            'preapplyConstraints':0,'output_type':'Update nodal variable','initializeFields':0,'geomDataIsCart':1}, redraw=0)
